...
import hrt from "../../../../assets/blood.png";
import thermo from "../../../../assets/blood.png";
import brain from "../../../../assets/blood.png";
import vector from "../../../../assets/blood.png";
import spine from "../../../../assets/blood.png";
    ...
    return (
        <>
            <Box sx={{ flexGrow: 1, ml: 1, mr: 1, mt: 1, bgcolor: "#ffffff", }}>
                    ...
                    <Grid item xs={3} sm={3} md={3} lg={3}>
                        <Box sx={{ border: '1px solid #B2B3AE', borderRadius: "4px", padding: '10px' }}>
                            ...
                            <TextField id="standard-basic" label="Temp" variant="standard" name="Temp_core"
                                value={temp1 || ''} onChange={(e) => setTemp1(e.target.value)} disabled
                            // error={!!errors.temp}
                    ...
                    <Grid item xs={3} sm={3} md={3} lg={3}>
                        <Box sx={{ border: '1px solid #B2B3AE', borderRadius: "4px", padding: '10px' }}>
                            ...
                            <TextField id="standard-basic" label="RR" variant="standard" name="RR"
                                value={rr1 || ''} onChange={(e) => setRR1(e.target.value)} disabled
                            // error={!!errors.rr}
                    ...
                    <Grid item xs={3} sm={3} md={3} lg={3}>
                        <Box sx={{ border: '1px solid #B2B3AE', borderRadius: "4px", padding: '10px' }}>
                            ...
                            <TextField id="standard-basic" label="GCS" variant="standard" name="GCS_Total"
                                value={gcs1 || ''} onChange={(e) => setGCS1(e.target.value)} disabled
                            // error={!!errors.gcs}
                    ...
                    <Grid item xs={3} sm={3} md={3} lg={3}>
                        <Box sx={{ border: '1px solid #B2B3AE', borderRadius: "4px", padding: '10px' }}>
                            ...
                            <TextField id="standard-basic" label="SpO2" variant="standard" name="SpO2"
                                value={sp1 || ''} onChange={(e) => setSP1(e.target.value)} disabled
                            // error={!!errors.sp}
                    ...
                    <Grid item xs={3} sm={3} md={3} lg={3}>
                        <Box sx={{ border: '1px solid #B2B3AE', borderRadius: "4px", padding: '10px' }}>
                            ...
                            <TextField id="standard-basic" label="TBSL" variant="standard" name="TBSL"
                                value={tb1 || ''} onChange={(e) => setTB1(e.target.value)} disabled
                            // error={!!errors.tb}
                    ...
                    <Grid item xs={3} sm={3} md={3} lg={3}>
                        <Box sx={{ border: '1px solid #B2B3AE', borderRadius: "4px", padding: '10px' }}>
                            ...
                            <TextField id="standard-basic" label="BP" variant="standard" name="BP"
                                value={bp1 || ''} onChange={(e) => setBP1(e.target.value)} disabled
                            // error={!!errors.bp}
                ...
                <Grid item xs={12} sm={12} lg={12} sx={{ mt: 1, ml: 40 , mb: 4 }}>
