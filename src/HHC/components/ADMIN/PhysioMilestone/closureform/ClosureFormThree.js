                ...
                <Grid item xs={12} container spacing={1} sx={{ mt: 1 }}>
                    <Grid item xs={12} sm={12} md={4} lg={4}>
                        <Box sx={{ border: '1px solid #B2B3AE', borderRadius: "4px", padding: '8px' }}>
                            <FormControl disabled>
                                ...
                                >
                                    <FormControlLabel value="1" control={<Radio disabled />} label="Healthy" />
                                    <FormControlLabel value="2" control={<Radio disabled/>} label="Unhealthy" />
                                </RadioGroup>
                            </FormControl>
                        </Box>
                    </Grid>
                    <Grid item xs={12} sm={12} md={8} lg={8}>
                        <Box sx={{ border: '1px solid #B2B3AE', borderRadius: "4px", padding: '8px' }}>
                            <FormControl disabled>
                                ...
                                >
                                    <FormControlLabel value="1" control={<Radio disabled/>} label="Serious" />
                                    <FormControlLabel value="2" control={<Radio disabled/>} label="Serosanguinous" />
                                    <FormControlLabel value="3" control={<Radio disabled/>} label="Sanguinous" />
                                    <FormControlLabel value="4" control={<Radio disabled/>} label="Purulent" />
                                </RadioGroup>
                            </FormControl>
                        </Box>
                    </Grid>
                    <Grid item xs={12} sm={12} md={4} lg={4}>
                        <Box sx={{ border: '1px solid #B2B3AE', borderRadius: "4px", padding: '8px' }}>
                            <FormControl disabled>
                                ...
                                >
                                    <FormControlLabel value="1" control={<Radio disabled/>} label="Present" />
                                    <FormControlLabel value="2" control={<Radio disabled/>} label="Absent" />
                                </RadioGroup>
                            </FormControl>
                        </Box>
                    </Grid>
                    <Grid item xs={12} sm={12} md={4} lg={4}>
                        <Box sx={{ border: '1px solid #B2B3AE', borderRadius: "4px", padding: '8px' }}>
                            <FormControl disabled>
                                ...
                                >
                                    <FormControlLabel value="1" control={<Radio disabled/>} label="Healing" />
                                    <FormControlLabel value="2" control={<Radio disabled/>} label="NotHealing" />
                                </RadioGroup>
                            </FormControl>
                        </Box>
                    </Grid>
                    <Grid item xs={12} sm={12} md={4} lg={4}>
                        {/* <TextField
                            ...
                            error={submitAttempted && !medGovRemark.trim()}
                            helperText={submitAttempted && !medGovRemark.trim() ? "Governance Remark is required" : ""}
                        /> */}
                    </Grid>
                </Grid>
