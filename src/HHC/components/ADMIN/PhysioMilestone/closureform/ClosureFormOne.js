          ...
          <Grid item xs={4} sm={4} md={4} lg={4}>
            ...
            >
              <FormControl disabled>
                <FormLabel id="demo-row-radio-buttons-group-label" disabled>
                  Baseline
                </FormLabel>
                <RadioGroup
                  row
        ...
        <Grid container sx={{ mt: 1 }}>
          <Grid item xs={12} sm={12} md={6} lg={6}>
            {/* <TextField
                            ...
                            helperText={submitAttempted && !medGovRemark.trim() ? "Medical Governance Remark is required" : ""}
                        // value={remark}
