...
const Addservice = () => {
  ...
  const [selectedService, setSelectedService] = useState(
    enqToServiceSrv ? enqToServiceSrv.srv_id : ""
  );
  ...
  const handleCouponSelect = (couponId) => {
    const selectedCoupon = coupon.find(
      (item) => item.coupon_id === couponId.target.value
    );
    if (selectedCoupon) {
    ...
    const calculateCouponDiscount = async () => {
      if (calculatedAmount && selectedCoupon) {
        ...
        try {
          ...
          console.error(
            "Error fetching Calculated Amount with Coupon Code:",
            error
          );
        }
      }
  ...
  async function handleSubmit(event, actionType) {
    ...
    if (enqToServicePtn && enqToServicePay) {
      ...
      requestData.langitude = enqToServicePtn.langitude
        ...
        : long;
      requestData.Total_cost = enqToServicePay.Total_cost
    ...
    if (enqToServiceSrv) {
      ...
      requestData.sub_srv_id = enqToServiceSrv.sub_srv_id
      ...
      requestData.end_time = enqToServiceSrv.end_time
        ? enqToServiceSrv.end_time
        : endTime;
                        ...
                        <>
                          ...
                          <Grid item lg={6} sm={6} xs={12}>
                            <TextField
                              ...
                              onChange={(e) =>
                                selectedPatient
                                  ? handleFieldEdit("hosp_id", e.target.value)
                            ...
                            <Grid container spacing={1}>
                              <Grid item xs={6}>
                                <TextField
                                  ...
                                  value={
                                    selectedPatient
                                      ? selectedPatient.state.state_id
                                      : selectedState
                                  }
                                  onChange={(e) =>
                                    selectedPatient
                              ...
                              <Grid item xs={6}>
                                ...
                                >
                                  ...
                                  {selectedPatient && selectedPatient.city && (
                                    <MenuItem
                                      value={selectedPatient.city.city_id}
                                    >
                              ...
                              <Grid item xs={6}>
                                ...
                                >
                                  ...
                                  {selectedPatient && selectedPatient.zone && (
                                    <MenuItem
                                      value={selectedPatient.zone.prof_zone_id}
                                    >
                        ...
                        <Grid container spacing={1}>
                          ...
                          <Grid item xs={6}>
                            ...
                            >
                              ...
                              {enqToServicePtn.city_id ? (
                                <MenuItem
                                  value={enqToServicePtn.city_id.city_id}
                                >
                        ...
                        <Grid container spacing={1}>
                          <Grid item xs={6}>
                            <TextField
                              ...
                              error={
                                (enqToServicePtn.lattitude === null && !lat) ||
                                !!errors.lat
                              }
                              helperText={
                                enqToServicePtn.lattitude === null && !lat
                          ...
                          <Grid item xs={6}>
                            <TextField
                              ...
                              error={
                                (enqToServicePtn.langitude === null && !long) ||
                                !!errors.long
                              }
                              helperText={
                                enqToServicePtn.langitude === null && !long
                    ...
                    <>
                      ...
                      <Grid item lg={12} sm={12} xs={12}>
                        <TextField
                          ...
                          onChange={(e) =>
                            enqToServiceSrv.sub_srv_id
                              ? handleFieldChange("sub_srv_id", e.target.value)
                              : handleSubServiceSelect(e)
                          }
                          ...
                          error={
                            (enqToServiceSrv.sub_srv_id === null &&
                              !selectedSubService) ||
                        ...
                        >
                          ...
                          enqToServiceSrv.sub_srv_id?.sub_srv_id ? (
                            <MenuItem
                              value={enqToServiceSrv.sub_srv_id?.sub_srv_id}
                              sx={{ fontSize: "14px" }}
                            >
                      ...
                      <Grid container spacing={1} sx={{ mt: 2, ml: 1 }}>
                        ...
                        <Grid item lg={6} sm={6} xs={6}>
                          <TextField
                            ...
                            error={
                              (enqToServiceSrv.end_date === null && !endDate) ||
                              endDateError !== "" ||
                              !!errors.endDate
                            }
                            helperText={
