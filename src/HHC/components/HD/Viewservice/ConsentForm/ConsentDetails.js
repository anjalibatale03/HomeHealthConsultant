...
const ConsentDetails = () => {
    ...
    async function handleSubmitConsent(e) {
        ...
        const fileName = `${consentDetails[0]?.eve_id?.agg_sp_pt_id?.name}.png`;
        ...
        if (Array.isArray(selectedFiles) && selectedFiles.length > 0) {
            ...
            formData.append("Discharge_summ_docs", emptyFile, null);
        }
        ...
        try {
            ...
            // setSnackbarMessage('Consent submitted successfully.');
