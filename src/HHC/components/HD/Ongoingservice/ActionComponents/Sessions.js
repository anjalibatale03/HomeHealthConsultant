  ...
  Closure
                                                    ...
                                                    >
                                                        <Box sx={{ ...style, width: formNo === 1 || formNo === 2 || formNo === 7 ? 1200 : 360, borderRadius: "10px", border: "none" }}>
                                                            {formNo === 1 && <Closureone evePlanID={eventPlanID} profSD={sesStartDate} profST={sesStartTime} profED={sesEndDate} profET={sesEndTime} formNo={formNo} sessions={sessions} onClose={handleCloseClosure} emt={getSessionDetils}/>}
                                                            {formNo === 2 && <Closuretwo eveID={eveID} evePlanID={eventPlanID} srvProfID={srvProfID} profSD={sesStartDate} profST={sesStartTime} profED={sesEndDate} sessions={sessions} profET={sesEndTime} formNo={formNo} onClose={handleCloseClosure} emt={getSessionDetils} />}
                                                            {formNo === 3 && <Closurethree evePlanID={eventPlanID} profSD={sesStartDate} profST={sesStartTime} profED={sesEndDate} profET={sesEndTime} formNo={formNo} sessions={sessions} onClose={handleCloseClosure} emt={getSessionDetils} />}
                                                            {formNo === 4 && <Closurefour evePlanID={eventPlanID} profSD={sesStartDate} profST={sesStartTime} profED={sesEndDate} profET={sesEndTime} formNo={formNo} sessions={sessions} onClose={handleCloseClosure} emt={getSessionDetils}/>}
                                                            {formNo === 5 && <Closurefive evePlanID={eventPlanID} profSD={sesStartDate} profST={sesStartTime} profED={sesEndDate} profET={sesEndTime} formNo={formNo} sessions={sessions} onClose={handleCloseClosure} emt={getSessionDetils}/>}
                                                            {formNo === 6 && <Closuresix evePlanID={eventPlanID} profSD={sesStartDate} profST={sesStartTime} profED={sesEndDate} profET={sesEndTime} formNo={formNo} sessions={sessions} onClose={handleCloseClosure} emt={getSessionDetils}/>}
                                                            {formNo === 7 && <Closureseven evePlanID={eventPlanID} profSD={sesStartDate} profST={sesStartTime} profED={sesEndDate} profET={sesEndTime} formNo={formNo} sessions={sessions} onClose={handleCloseClosure} emt={getSessionDetils}/>}
                                                            {formNo === 8 && <Closureeight evePlanID={eventPlanID} profSD={sesStartDate} profST={sesStartTime} profED={sesEndDate} profET={sesEndTime} formNo={formNo} sessions={sessions} onClose={handleCloseClosure} emt={getSessionDetils}/>}
                                                            {formNo === 9 && <Closurenine evePlanID={eventPlanID} profSD={sesStartDate} profST={sesStartTime} profED={sesEndDate} profET={sesEndTime} formNo={formNo} sessions={sessions} onClose={handleCloseClosure} emt={getSessionDetils}/>}
                                                            {formNo === 10 && <Closureten evePlanID={eventPlanID} profSD={sesStartDate} profST={sesStartTime} profED={sesEndDate} profET={sesEndTime} formNo={formNo} sessions={sessions} onClose={handleCloseClosure} emt={getSessionDetils}/>}
                                                        </Box>
                                                    </Modal>
