...
const Invoice = ({ eveID, onClose }) => {
  ...
  <Box sx={{ display: "grid", gridTemplateColumns: "150px 1fr", rowGap: 1 }}>
  ...
  Laukik Apartment,{"\n"}Bhandarkar Road, Pune
    ...
    <Typography variant="body2">50200109761561</Typography>
  </Box>
</CardContent>
<CardContent sx={{ mt: 5 }}>
  <Stack spacing={1.5}>
    <Stack direction="row" alignItems="center" spacing={1}>
      ...
      <Typography variant="body2">7620400100</Typography>
    </Stack>

    <Stack direction="row" alignItems="center" spacing={1}>
      <EmailOutlinedIcon sx={{ color: "#4A4A4A" }} />
      <Typography variant="body2">helpdesk@sperohomehealth.in</Typography>
    </Stack>

    <Stack direction="row" alignItems="center" spacing={1}>
      <LanguageOutlinedIcon sx={{ color: "#4A4A4A" }} />
      <Typography variant="body2">sperohomehealth.in</Typography>
    </Stack>
  </Stack>
</CardContent>
