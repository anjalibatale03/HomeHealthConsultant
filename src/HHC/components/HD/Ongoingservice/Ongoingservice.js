...
const Ongoingservice = ({ eveId, onClose, rows }) => {
        ...
        if (jobClosureStatus === sesCount) {
          ...
          navigate("/viewservice", {
            state: {
              ...
              eventID: eventValue,
              flag: 2,
              rescheduletoservice: rescheduleToAllocate,
            },
          });
        }
      } catch (error) {
  ...
  const [rescheduleToAllocate, setRescheduleToAllocate] = useState(1);
            ...
            <TableHead>
              <TableRow>
                ...
                >
                  ...
                  <CardContent
                    style={{ flex: 0.5, borderRight: "1px solid #FFFFFF", cursor: "pointer" }}
                  >
                      ...
                      >
                        <OngoingServiceCard style={{ height: "auto" }}>
                          ...
                          <CardContent style={{ flex: 1.2 }}>
                            ...
                            >
                              <Typography variant="body2" textAlign="left">
                                {row?.added_by?.slice ? `${row.added_by.slice(0, 5)}...` : "-"}
                              </Typography>
                            </Tooltip>
                          </CardContent>
                          <CardContent style={{ flex: 0.5 }}>
                            <Typography variant="body2" textAlign="left">
                              {row?.is_feedback_complete === true ? <CheckCircleOutlineIcon style={{ color: 'green' }} /> : <CancelIcon style={{ color: 'red' }} />}
                            </Typography>
                          </CardContent>
                          <CardContent style={{ flex: 0.2 }}>
                            {auth && (
